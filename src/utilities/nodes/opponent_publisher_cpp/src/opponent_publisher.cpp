...
public:
  ...
  : Node("opponent_follower")
  {
    ...
    speed_       = declare_parameter<double>("speed",       1.0);  // Default speed for stable opponent behavior (1.0 m/s, configurable)
...
private:
  ...
  double speed_{1.0};                // Default speed for stable opponent behavior (1.0 m/s, configurable)
