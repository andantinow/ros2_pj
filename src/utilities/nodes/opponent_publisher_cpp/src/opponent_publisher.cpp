...
public:
  ...
  : Node("opponent_follower")
  {
    ...
    speed_       = declare_parameter<double>("speed",       1.0);  // Default speed for stable opponent behavior (configurable)
...
private:
  ...
  double speed_{1.0};                // Default speed for stable opponent behavior (configurable)
