...
def main():
    ...
    parser.add_argument('--outer-offset', type=float, 
                        default=0.9,
                        help='Lateral offset for outer line in meters (default: 0.9)')
    parser.add_argument('--inner-offset', type=float, 
                        default=-0.9,
                        help='Lateral offset for inner line in meters (default: -0.9)')
    parser.add_argument('--speed-factor', type=float, 
                        default=0.5,
                        help='Speed reduction factor (default: 0.5 for half speed)')
